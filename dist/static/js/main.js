...
new Vue({
    ...
    methods: {
        ...
        openOverlay: function(cellIndex) {
            ...
            this.signHtml.next = (nextIndex != -1)
                ? '<span>' + this.cellList[nextIndex].atomicNum + '</span>'
                    + this.cellList[nextIndex].innerStr['element-symbol']
                : '<span>119</span>Uue';
            this.signHtml.previous = (previousIndex != -1)
                ? '<span>' + this.cellList[previousIndex].atomicNum + '</span>'
        ...
        beforeEnterFade: function(el) {
            ...
            bodyScrollLock.disableBodyScroll(targetEl, {reserveScrollBarGap: true});
            this.isHidden = true;
        },
        ...
        atomicNumToIndex: function(atomicNum) {
            return this.cellList.findIndex(element => element.atomicNum === atomicNum);
        },
        navOpen: function() {
        ...
        changeThemeColor: function(themeColorName) {
            ...
            const mainA = 'linear-gradient(0.375turn, '
                + themeColor.main1 + 'e6, '
                + themeColor.main2 + 'e6, '
                + themeColor.main3 + 'e6)';
